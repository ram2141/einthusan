...
def get_movie_detail(movie_id):
	time.sleep(0.4)
	API_URL = 'https://einthusan.tv/webservice/movie.php?id=' + str(movie_id)
...
def apply_filter(filters):
	API_URL = 'https://einthusan.tv/webservice/filters.php'
...
def get_options(attr, language):
	API_URL = 'https://einthusan.tv/webservice/discovery.php'
	data = 'lang='+language
