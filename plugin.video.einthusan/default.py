...
def login_info(s, referurl):
    ...
    headers={'Host':'einthusan.tv', 'Origin':'https://einthusan.com','Referer':referurl,'User-Agent':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36'}
